...
$href   = 'https://wa.me/' . $number . '?text=' . rawurlencode('Olá! Vim pelo site e gostaria de conversar sobre um projeto.');
?>
<a class="whatsapp-float" href="<?= e($href) ?>" target="_blank" rel="noopener" aria-label="Falar pelo WhatsApp">
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" width="28" height="28" fill="currentColor">
