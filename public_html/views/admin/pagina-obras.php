<form class="panel form-grid" method="post" enctype="multipart/form-data" action="<?= e(url('admin/paginas/obras')) ?>">
<?= Csrf::field() ?>
...
<div class="form-section form-section-open">
    <div class="section-label">
        ...
        <p>Cabeçalho exibido no topo da página de Obras / Portfólio.</p>
    </div>
    <label>Título
        <input name="hero_titulo" value="<?= e($campos['hero_titulo'] ?? '') ?>" maxlength="150" placeholder="Obras">
    </label>
    <label class="full">Subtítulo
        <input name="hero_subtitulo" value="<?= e($campos['hero_subtitulo'] ?? '') ?>" maxlength="200">
        <small class="field-help">Apresentação do portfólio de obras.</small>
    </label>
