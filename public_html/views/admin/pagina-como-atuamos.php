...
<div class="form-section form-section-open">
    <div class="section-label">
        ...
        <p>Contexto geral sobre o método de trabalho da empresa, exibido antes da lista de etapas.</p>
    </div>
    <label class="full">Texto
        <textarea name="intro_texto" rows="5"><?= e($campos['intro_texto'] ?? '') ?></textarea>
        <small class="field-help">Opcional. Se preenchido, aparece acima das etapas do processo.</small>
    </label>
</div>
